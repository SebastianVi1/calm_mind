...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<Map<String, dynamic>> questions = [
    ...
    {"question": "Ejemplo de pregunta?", "description": "Descripcion pregunta 2", "options": ["option1", "option2", "option3"]},
    {"question": "Ejemplo de pregunta?", "description": "Descripcion pregunta 3", "options": ["option1", "option2"]},
  ];
        ...
        children: List.generate(questions.length, (index) {
          return WQuestionWidget(
            ...
            onAnswerChanged: (int? answer) {
              setState(() {
                answers[index] = answer; // Update the answerlist
              });
            },
          );
        }),
